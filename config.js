...
const config = {
   ...
   language: {
      detectLanguages: process.env.LANGUAGE_DETECTED
         ? process.env.LANGUAGE_DETECTED.split(",")
         : [],
      addChineseWeight: process.env.LANGUAGE_ADD_CHINESE_WEIGHT === "true" || false,
      readMessageSpeed: process.env.LANGUAGE_READ_SPEED
         ? JSON.parse(process.env.LANGUAGE_READ_SPEED)
         : {},
   ...
   twitch: {
      ...
      ignoreChannels: process.env.TWITCH_IGNORE_CHANNELS
         ? process.env.TWITCH_IGNORE_CHANNELS.split(",")
         : [],
   ...
   youtube: {
      ...
      ignoreChannels: process.env.YOUTUBE_IGNORE_CHANNEL_IDS
         ? process.env.YOUTUBE_IGNORE_CHANNEL_IDS.split(",")
         : [],
      admins: process.env.YOUTUBE_ADMIN_CHANNEL_IDS
         ? process.env.YOUTUBE_ADMIN_CHANNEL_IDS.split(",")
         : [],
   },

   queue: {
      enable5ma: process.env.QUEUE_ENABLE_5MA === "true" || false,
      soundFile5ma: process.env.QUEUE_5MA_SOUND_FILE || "",
   },
