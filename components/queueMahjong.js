...
export default class QueueMahjong extends Component{
    ...
    handleAdminMessage(client,message,messageHandler){
       ...
       switch (command){
            ...
            case "add": this.add(params,false,client, messageHandler); break;
            case "addFront": this.add(params,true,client, messageHandler); break;
            case "remove": this.remove(params,false,client, messageHandler); break;
            case "removeIdx": this.remove(params,true,client, messageHandler); break;
            case "clear": this.clear(client, messageHandler); break;
            case "3ma": this.startGame([3], true, client, messageHandler); break;
            case "4ma": this.startGame([4], true, client, messageHandler); break;
